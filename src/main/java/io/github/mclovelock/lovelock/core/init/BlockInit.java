...
public class BlockInit {
	...
	public static final RegistryObject<Block> ELECTROLYSER = registerBlockWithoutBlockItem("electrolyser", () -> new CustomBlock(
			BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).requiresCorrectToolForDrops()));

	public static final RegistryObject<Item> ELECTROLYSER1 = registerBlockItem("electrolyser", ELECTROLYSER);
